...
class _$_Attributes implements _Attributes {
  ...
  @override
  String toString() {
    return 'Attributes(name: $name, description: $description, latitude: $latitude, longitude: $longitude, address: $address, photo: $photo, userId: $userId, createdAt: $createdAt, updatedAt: $updatedAt, publishedAt: $publishedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, name, description, latitude,
      longitude, address, photo, userId, createdAt, updatedAt, publishedAt);
